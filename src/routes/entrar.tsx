          ...
          <div className="w-full max-w-md">
            <div className="relative panel p-7 sm:p-8 glow-brand overflow-hidden">
              ...
              <div className="relative">
                ...
                <Button type="button" variant="outline" className="w-full mb-4" onClick={() => blink.auth.login(window.location.origin + "/entrar?modo=login")}>Entrar com minha conta Blink</Button>
