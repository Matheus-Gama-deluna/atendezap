              ...
              <Section title="Cérebro da IA" icon={<Sparkles className="size-3.5" />}>
                <div className="space-y-1.5">
                  ...
                  <Select value={cfg.ai_provider} onValueChange={(v) => { up("ai_provider", v); up("ai_model", PROVIDER_MODELS[v]?.[0]?.value || ""); }}>
                    ...
                    <SelectContent>
                      <SelectItem value="gemini">Google Gemini — créditos Blink</SelectItem>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Gemini usa a IA da Blink e pode consumir créditos do seu workspace. {(!allowOpenAI || !allowAnthropic) && (
